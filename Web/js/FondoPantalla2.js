document.addEventListener('DOMContentLoaded', () => {
    ...
    switch (twoHourSegments) {
        case 0:
        case 1:
            videoPath = '../assets/fondoPantalla/madrugada.mp4'; // 0-1, 2-3
            break;
        case 2:
        case 3:
            videoPath = '../assets/fondoPantalla/amanecer.mp4'; // 4-5, 6-7
            break;
        case 4:
        case 5:
            videoPath = '../assets/fondoPantalla/mañana.mp4'; // 8-9, 10-11
            break;
        case 6:
        case 7:
        ...
        case 8:
        case 9:
            videoPath = '../assets/fondoPantalla/tarde.mp4'; // 16-17, 18-19
            break;
        case 10:
        case 11:
            videoPath = '../assets/fondoPantalla/noche.mp4'; // 20-21, 22-23
            break;
        default:
